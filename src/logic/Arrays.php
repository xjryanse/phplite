...
class Arrays {
    ...
    public static function isEmpty($array) {
        ...
        //情况2：只有一个null值,或空值
        // 20250319：增加array_values
        $arrUniq = array_values(array_unique($array));
        return count($arrUniq) == 1 && (is_null($arrUniq[0]) || $arrUniq[0] == '');
    }
...
//            }
    ...
    public static function toXml($data, $withFix = true) {
        ...
        return $withFix ? '<xml>' . $string . '</xml>' : $string;
    }
